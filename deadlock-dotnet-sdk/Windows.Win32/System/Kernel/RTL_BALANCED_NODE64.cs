...
internal unsafe struct RTL_BALANCED_NODE64
{
    ...
    internal UIntPtr64<RTL_BALANCED_NODE64> Left { get => (UIntPtr64<RTL_BALANCED_NODE64>)left; set => left = (UIntPtr64)value; }
    internal UIntPtr64<RTL_BALANCED_NODE64> Right { get => (UIntPtr64<RTL_BALANCED_NODE64>)right; set => right = (UIntPtr64)value; }
}
