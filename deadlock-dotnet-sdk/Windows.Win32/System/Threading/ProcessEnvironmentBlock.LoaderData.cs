...
public partial class ProcessEnvironmentBlock
{
    ...
    {
        internal LoaderData(PEB_LDR_DATA32 loaderData32)
        {
        ...
        internal LoaderData(PEB_LDR_DATA64 loaderData64)
        {
        ...
        internal (UIntPtr32? w32, UIntPtr64? w64) SsHandle;
        ...
        internal (LIST_ENTRY32? w32, LIST_ENTRY64? w64) InLoadOrderModuleList;
        ...
        internal (LIST_ENTRY32? w32, LIST_ENTRY64? w64) InMemoryOrderModuleList;
        ...
        internal (LIST_ENTRY32? w32, LIST_ENTRY64? w64) InInitializationOrderModuleList;
        internal (UIntPtr32? w32, UIntPtr64? w64) EntryInProgress; // 5.1 and higher
        public BOOLEAN ShutdownInProgress; // late 6.0 and higher
        internal (HANDLE32? w32, HANDLE64? w64) ShutdownThreadId; // late 6.0 and higher
    }
}
