...
public struct PEB64
{
    ...
    [FieldOffset(0x00)] public readonly BOOLEAN InheritedAddressSpace;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x01)] public readonly BOOLEAN ReadImageFileExecOptions;
    /// <summary>
    ...
    /// </summary>
    [FieldOffset(0x02)] public readonly BOOLEAN BeingDebugged;
    /// <summary>Compatibility: late 5.2 and higher</summary>
    [FieldOffset(0x03)] public readonly PEB_BitField BitField;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x08)] public readonly HANDLE64 Mutant;
    #endregion INITIAL_PEB

    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x20)] public readonly UIntPtr64 ImageBaseAddress;
    ...
    [FieldOffset(0x18)] public readonly unsafe UIntPtr64<PEB_LDR_DATA64> Ldr;
    /// <summary>Compatibility: All<br/>
    ...
    [FieldOffset(0x20)] public readonly unsafe UIntPtr64<RTL_USER_PROCESS_PARAMETERS64> ProcessParameters;
    /// <summary>Compatibility: all<br/>
    ...
    [FieldOffset(0x28)] public readonly UIntPtr64 SubSystemData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x30)] public readonly UIntPtr64 ProcessHeap;
    ...
    [FieldOffset(0x38)] public readonly UIntPtr64<RTL_CRITICAL_SECTION64> FastPebLock;
    /// <summary>Compatibility: 3.10 to 5.1</summary>
    [FieldOffset(0x40), Obsolete] private readonly UIntPtr64 FastPebLockRoutine;
    /// <summary>Compatibility: late 5.2 and higher</summary>
    [FieldOffset(0x40)] public readonly unsafe UIntPtr64 AtlThunkSListPtr;
    /// <summary>Compatibility: 3.10 to 5.1</summary>
    [FieldOffset(0x48), Obsolete] private readonly UIntPtr64 FastPebUnlockRoutine;
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x48)] public readonly UIntPtr64 IFEOKey;

    /// <summary>Compatibility: 3.50 to 5.2</summary>
    [FieldOffset(0x50), Obsolete] private readonly uint EnvironmentUpdateCount;
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x50)] public readonly PEB_CrossProcess CrossProcessFlags;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x58)] public readonly UIntPtr64 KernelCallBackTable;
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x58)] public readonly UIntPtr64 UserSharedInfoPtr;
    ...
    [FieldOffset(0x64)] public readonly UIntPtr64 AtlThunkSListPtr32;
    ...
    [FieldOffset(0x68)] public readonly UIntPtr64 ApiSetMap;

    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x70)] public readonly uint TlsExpansionCounter;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x78)] public readonly UIntPtr64 TlsBitmap;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x80)] private unsafe fixed uint TlsBitmapBits[2];
    public readonly unsafe uint[] TlsBitmapBits_Safe => new uint[2] { TlsBitmapBits[0], TlsBitmapBits[1] };

    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x88)] public readonly UIntPtr64 ReadOnlySharedMemoryBase;
    ...
    [FieldOffset(0x90)] public readonly UIntPtr64 SharedData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x98)] public readonly UIntPtr64<UIntPtr64> ReadOnlyStaticServerData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0xA0)] public readonly UIntPtr64 AnsiCodePageData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0xA8)] public readonly UIntPtr64 OemCodePageData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0xB0)] public readonly UIntPtr64 UnicodeCaseTableData;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xB8)] public readonly uint NumberOfProcessors;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xBC)] public readonly uint NtGlobalFlag;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xC0)] public readonly long CriticalSectionTimeout;

    #region Appended for Windows NT 3.51
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xC8)] public readonly UIntPtr64 HeapSegmentReserve;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xD0)] public readonly UIntPtr64 HeapSegmentCommit;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xD8)] public readonly UIntPtr64 HeapDeCommitTotalFreeThreshold;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xE0)] public readonly UIntPtr64 HeapDeCommitFreeBlockThreshold;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xE8)] public readonly uint NumberOfHeaps;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xEC)] public readonly uint MaximumNumberOfHeaps;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xF0)] public readonly UIntPtr64<UIntPtr64> ProcessHeaps;
    #endregion Appended for Windows NT 3.51

    #region Appended for Windows NT 4.0
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0xF8)] public readonly UIntPtr64 GdiSharedHandleTable;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x0100)] public readonly UIntPtr64 ProcessTarterHelper;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x0108)] public readonly uint GdiDCAttributeList;
    ...
    [FieldOffset(0x0110)] public readonly UIntPtr64<RTL_CRITICAL_SECTION64> LoaderLock;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x0118)] public readonly uint OSMajorVersion;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x011C)] public readonly uint OSMinorVersion;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x0120)] public readonly ushort OSBuildNumber;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x0122)] public readonly ushort OSCSDVersion;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x0124)] public readonly uint OSPlatformId;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x0128)] public readonly uint ImageSubsystem;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x012C)] public readonly uint ImageSubsystemMajorVersion;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x0130)] public readonly uint ImageSubsystemMinorVersion;
    ...
    [FieldOffset(0x0138)] public readonly KAFFINITY64 ActiveProcessAffinityMask;
    ...
    [FieldOffset(0x0140)] private unsafe fixed uint GdiHandleBuffer[0x3C];
    public unsafe uint[] GdiHandleBuffer_Safe
    {
        get
        {
    ...
    [FieldOffset(0x0230)] public readonly UIntPtr64 PostProcessInitRoutine;
    /// <summary>Compatibility: 5.0 and higher</summary>
    [FieldOffset(0x0238)] public readonly UIntPtr64 TlsExpansionBitmap;
    /// <summary>Compatibility: 5.0 and higher</summary>
    [FieldOffset(0x0240)] private unsafe fixed uint TlsExpansionBitmapBits[0x20];
    public unsafe uint[] TlsExpansionBitmapBits_Safe
    {
        get
        {
    ...
    [FieldOffset(0x02C0)] public readonly uint SessionId;

    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x02C8)] public readonly PEB_AppCompat AppCompatFlags;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x02D0)] public readonly PEB_AppCompat AppCompatFlagsUser;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x02D8)] public readonly UIntPtr64 pShimData;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x02E0)] public readonly UIntPtr64 AppCompatInfo;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x02E8)] public readonly UNICODE_STRING64 CSDVersion;
    ...
    [FieldOffset(0x02F8)] public readonly UIntPtr64 ActivationContextData;
    /// <summary>Compatibility: 5.1 and higher
    /// Type: ACTIVATION_CONTEXT_DATA *</summary>
    [FieldOffset(0x0300)] public readonly UIntPtr64 ProcessAssemblyStorageMap;
    /// <summary>Compatibility: 5.1 and higher
    /// Type: ACTIVATION_CONTEXT_DATA const *</summary>
    [FieldOffset(0x0308)] public readonly UIntPtr64 SystemDefaultActivationContextData;
    /// <summary>Compatibility: 5.1 and higher
    /// Type: ASSEMBLY_STORAGE_MAP *</summary>
    [FieldOffset(0x310)] public readonly UIntPtr64 SystemAssemblyStorageMap;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x318)] public readonly UIntPtr64 MinimumStackCommit;
    ...
    [FieldOffset(0x0320)] public readonly UIntPtr64 FlsCallback;
    /// <summary>Compatibility: 5.2 to 1809</summary>
    [FieldOffset(0x0328)] public readonly LIST_ENTRY64 FlatListHead; // 5.2 to 1809
    /// <summary>Compatibility: 5.2 to 1809</summary>
    [FieldOffset(0x0338)] public readonly UIntPtr64 FlsBitmap;
    /// <summary>Compatibility: 5.2 to 1809</summary>
    [FieldOffset(0x0340)] private unsafe fixed uint FlsBitmapBits[4];
    ...
    /// <summary>Compatibility: 5.2 to 1809</summary>
    [FieldOffset(0x0350)] public readonly uint FlsHighIndex;
    #endregion Appended for Windows Server 2003

    #region Appended for Windows Vista
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x0358)] public readonly UIntPtr64 WerRegistrationData;
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x0360)] public readonly UIntPtr64 WerShipAssertPtr;
    #endregion Appended for Windows Vista

    #region Appended for Windows 7
    /// <summary>Compatibility: 6.1 only</summary>
    [FieldOffset(0x0368)] public readonly UIntPtr64 pContextData;
    /* [FieldOffset(0x0238)] internal readonly UIntPtr64 pUnused; */
    /// <summary>Compatibility: 6.1 and higher</summary>
    [FieldOffset(0x0370)] public readonly UIntPtr64 pImageHeaderHash;
    [FieldOffset(0x0378)] public readonly PEB_Tracing TracingFlags;
    #endregion Appended for Windows 7

    #region Appended for Windows 8
    /// <summary>Compatibility: 6.2 and higher</summary>
    [FieldOffset(0x0380)] public readonly ulong CsrServerReadOnlySharedMemoryBase;
    #endregion Appended for Windows 8

    #region Appended Later in Windows 10
    /// <summary>Compatibility: 1511 and higher</summary>
    [FieldOffset(0x0388)] public readonly uint TppWorkerpListLock;
    /// <summary>Compatibility: 1511 and higher</summary>
    [FieldOffset(0x0390)] public readonly LIST_ENTRY64 TppWorkerList;
    /// <summary>Compatibility: 1511 and higher<br/>
    /// Type: Fixed Array of void*</summary>
    [FieldOffset(0x03A0)] private unsafe fixed ulong WaitOnAddressHashTable[0x80];
    public unsafe ulong[] WaitOnAddressHashTable_Safe
    {
        get
        {
            ulong[] v = new ulong[0x80];
    ...
    [FieldOffset(0x07A0)] public readonly UIntPtr64 TelemetryCoverageHeader;
    /// <summary>Compatibility: 1709 and higher</summary>
    [FieldOffset(0x07A8)] public readonly uint CloudFileFlags;
    /// <summary>Compatibility: 1803 and higher</summary>
    [FieldOffset(0x07AC)] public readonly uint CloudFileDiagFlags;
    /// <summary>Compatibility: 1803 and higher</summary>
    [FieldOffset(0x07B0)] public readonly byte PlaceholderCompatibilityMode;
    /// <summary>Compatibility: 1803 and higher
    /// Type: LEAP_SECOND_DATA *</summary>
    [FieldOffset(0x07B8)] public readonly UIntPtr64 LeapSecondData;
    [FieldOffset(0x07C0)] public readonly PEB_LeapSecond LeapSecondFlags;
    /// <summary>Compatibility: 1803 and higher</summary>
    ...
    [FieldOffset(0x07C4)] public readonly uint NtGlobalFlag2;
