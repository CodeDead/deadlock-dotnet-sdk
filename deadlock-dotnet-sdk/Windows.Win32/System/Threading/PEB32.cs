...
public struct PEB32
{
    ...
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x04)] public readonly HANDLE32 Mutant;
    #endregion INITIAL_PEB

    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x08)] public readonly UIntPtr32 ImageBaseAddress;
    ...
    [FieldOffset(0x0C)] public readonly unsafe UIntPtr32<PEB_LDR_DATA32> Ldr;
    /// <summary>Compatibility: All<br/>
    ...
    [FieldOffset(0x10)] public readonly unsafe UIntPtr32<RTL_USER_PROCESS_PARAMETERS32> ProcessParameters;
    /// <summary>Compatibility: all<br/>
    ...
    [FieldOffset(0x14)] public readonly UIntPtr32 SubSystemData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x18)] public readonly UIntPtr32 ProcessHeap;
    ...
    [FieldOffset(0x1C)] public readonly UIntPtr32<RTL_CRITICAL_SECTION32> FastPebLock;
    /// <summary>Compatibility: 3.10 to 5.1</summary>
    [FieldOffset(0x20), Obsolete] private readonly UIntPtr32 FastPebLockRoutine;
    /// <summary>Compatibility: late 5.2 and higher</summary>
    [FieldOffset(0x20)] public readonly unsafe UIntPtr32 AtlThunkSListPtr;
    /// <summary>Compatibility: 3.10 to 5.1</summary>
    [FieldOffset(0x24), Obsolete] private readonly UIntPtr32 FastPebUnlockRoutine;
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x24)] public readonly UIntPtr32 IFEOKey;

    /// <summary>Compatibility: 3.50 to 5.2</summary>
    [FieldOffset(0x28), Obsolete] private readonly uint EnvironmentUpdateCount;
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x28)] public readonly PEB_CrossProcess CrossProcessFlags;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x2C)] public readonly UIntPtr32 KernelCallBackTable;
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x2C)] public readonly UIntPtr32 UserSharedInfoPtr;
    ...
    [FieldOffset(0x34)] public readonly UIntPtr32 AtlThunkSListPtr32;
    ...
    [FieldOffset(0x38)] public readonly UIntPtr32 ApiSetMap;

    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x3C)] public readonly uint TlsExpansionCounter;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x40)] public readonly UIntPtr32 TlsBitmap;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x44)] private unsafe fixed uint TlsBitmapBits[2];
    public readonly unsafe uint[] TlsBitmapBits_Safe => new uint[2] { TlsBitmapBits[0], TlsBitmapBits[1] };

    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x4C)] public readonly UIntPtr32 ReadOnlySharedMemoryBase;
    ...
    [FieldOffset(0x50)] public readonly UIntPtr32 SharedData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x54)] public readonly UIntPtr32<UIntPtr32> ReadOnlyStaticServerData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x58)] public readonly UIntPtr32 AnsiCodePageData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x5C)] public readonly UIntPtr32 OemCodePageData;
    /// <summary>Compatibility: all</summary>
    [FieldOffset(0x60)] public readonly UIntPtr32 UnicodeCaseTableData;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x64)] public readonly uint NumberOfProcessors;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x68)] public readonly uint NtGlobalFlag;
    ...
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x70)] public readonly long CriticalSectionTimeout;

    #region Appended for Windows NT 3.51
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x78)] public readonly UIntPtr32 HeapSegmentReserve;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x7C)] public readonly UIntPtr32 HeapSegmentCommit;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x80)] public readonly UIntPtr32 HeapDeCommitTotalFreeThreshold;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x84)] public readonly UIntPtr32 HeapDeCommitFreeBlockThreshold;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x88)] public readonly uint NumberOfHeaps;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x8C)] public readonly uint MaximumNumberOfHeaps;
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x90)] public readonly UIntPtr32<UIntPtr32> ProcessHeaps;
    #endregion Appended for Windows NT 3.51

    #region Appended for Windows NT 4.0
    /// <summary>Compatibility: 3.51 and higher</summary>
    [FieldOffset(0x94)] public readonly UIntPtr32 GdiSharedHandleTable;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x98)] public readonly UIntPtr32 ProcessTarterHelper;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0x9C)] public readonly uint GdiDCAttributeList;
    ...
    [FieldOffset(0xA0)] public readonly UIntPtr32<RTL_CRITICAL_SECTION32> LoaderLock;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0xA4)] public readonly uint OSMajorVersion;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0xA8)] public readonly uint OSMinorVersion;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0xAC)] public readonly ushort OSBuildNumber;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0xAE)] public readonly ushort OSCSDVersion;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0xB0)] public readonly uint OSPlatformId;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0xB4)] public readonly uint ImageSubsystem;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0xB8)] public readonly uint ImageSubsystemMajorVersion;
    /// <summary>Compatibility: 4.0 and higher</summary>
    [FieldOffset(0xBC)] public readonly uint ImageSubsystemMinorVersion;
    ...
    [FieldOffset(0xC0)] public readonly KAFFINITY32 ActiveProcessAffinityMask;
    ...
    [FieldOffset(0xC4)] private unsafe fixed uint GdiHandleBuffer[0x3C];
    ...
    [FieldOffset(0x014C)] public readonly UIntPtr32 PostProcessInitRoutine;
    /// <summary>Compatibility: 5.0 and higher</summary>
    [FieldOffset(0x0150)] public readonly UIntPtr32 TlsExpansionBitmap;
    /// <summary>Compatibility: 5.0 and higher</summary>
    [FieldOffset(0x0154)] private unsafe fixed uint TlsExpansionBitmapBits[0x20];
    ...
    [FieldOffset(0x01D4)] public readonly uint SessionId;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x01D8)] public readonly PEB_AppCompat AppCompatFlags;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x01E0)] public readonly PEB_AppCompat AppCompatFlagsUser;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x01E8)] public readonly UIntPtr32 pShimData;
    /// <summary>Compatibility: 5.0</summary>
    [FieldOffset(0x01D8), Obsolete] private readonly UIntPtr32 AppCompatInfo_NT5;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x01EC)] public readonly UIntPtr32 AppCompatInfo;
    /// <summary>Compatibility: 5.0</summary>
    [FieldOffset(0x01DC), Obsolete] private readonly UNICODE_STRING32 CSDVersion_NT5;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x01F0)] public readonly UNICODE_STRING32 CSDVersion;
    ...
    [FieldOffset(0x01F8)] public readonly UIntPtr32 ActivationContextData;
    /// <summary>Compatibility: 5.1 and higher
    /// Type: ACTIVATION_CONTEXT_DATA *</summary>
    [FieldOffset(0x01FC)] public readonly UIntPtr32 ProcessAssemblyStorageMap;
    /// <summary>Compatibility: 5.1 and higher
    /// Type: ACTIVATION_CONTEXT_DATA const *</summary>
    [FieldOffset(0x0200)] public readonly UIntPtr32 SystemDefaultActivationContextData;
    /// <summary>Compatibility: 5.1 and higher
    /// Type: ASSEMBLY_STORAGE_MAP *</summary>
    [FieldOffset(0x204)] public readonly UIntPtr32 SystemAssemblyStorageMap;
    /// <summary>Compatibility: 5.1 and higher</summary>
    [FieldOffset(0x208)] public readonly UIntPtr32 MinimumStackCommit;
    ...
    [FieldOffset(0x020C)] public readonly UIntPtr32 FlsCallback;
    /// <summary>Compatibility: 5.2 to 1809</summary>
    [FieldOffset(0x0210)] public readonly LIST_ENTRY32 FlatListHead; // 5.2 to 1809
    /// <summary>Compatibility: 5.2 to 1809</summary>
    [FieldOffset(0x0218)] public readonly UIntPtr32 FlsBitmap;
    /// <summary>Compatibility: 5.2 to 1809</summary>
    [FieldOffset(0x021C)] private unsafe fixed uint FlsBitmapBits[4];
    ...
    /// <summary>Compatibility: 5.2 to 1809</summary>
    [FieldOffset(0x022C)] public readonly uint FlsHighIndex;
    #endregion Appended for Windows Server 2003

    #region Appended for Windows Vista
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x0230)] public readonly UIntPtr32 WerRegistrationData;
    /// <summary>Compatibility: 6.0 and higher</summary>
    [FieldOffset(0x0234)] public readonly UIntPtr32 WerShipAssertPtr;
    #endregion Appended for Windows Vista

    #region Appended for Windows 7
    /// <summary>Compatibility: 6.1 only</summary>
    [FieldOffset(0x0238)] public readonly UIntPtr32 pContextData;
    /* [FieldOffset(0x0238)] internal readonly UIntPtr32 pUnused; */
    /// <summary>Compatibility: 6.1 and higher</summary>
    [FieldOffset(0x023C)] public readonly UIntPtr32 pImageHeaderHash;
    [FieldOffset(0x0240)] public readonly PEB_Tracing TracingFlags;
    #endregion Appended for Windows 7

    #region Appended for Windows 8
    /// <summary>Compatibility: 6.2 and higher</summary>
    [FieldOffset(0x0248)] public readonly ulong CsrServerReadOnlySharedMemoryBase;
    #endregion Appended for Windows 8

    #region Appended Later in Windows 10
    /// <summary>Compatibility: 1511 and higher</summary>
    [FieldOffset(0x0250)] public readonly uint TppWorkerpListLock;
    /// <summary>Compatibility: 1511 and higher</summary>
    [FieldOffset(0x0254)] public readonly LIST_ENTRY32 TppWorkerList;
    /// <summary>Compatibility: 1511 and higher<br/>
    /// Type: Fixed Array of void*</summary>
    [FieldOffset(0x025C)] private unsafe fixed uint WaitOnAddressHashTable[0x80];
    public unsafe uint[] WaitOnAddressHashTable_Safe
    {
        get
        {
    ...
    [FieldOffset(0x045C)] public readonly UIntPtr32 TelemetryCoverageHeader;
    /// <summary>Compatibility: 1709 and higher</summary>
    [FieldOffset(0x0460)] public readonly uint CloudFileFlags;
    /// <summary>Compatibility: 1803 and higher</summary>
    [FieldOffset(0x0464)] public readonly uint CloudFileDiagFlags;
    /// <summary>Compatibility: 1803 and higher</summary>
    [FieldOffset(0x0468)] public readonly byte PlaceholderCompatibilityMode;
    /// <summary>Compatibility: 1803 and higher
    /// Type: LEAP_SECOND_DATA *</summary>
    [FieldOffset(0x0470)] public readonly UIntPtr32 LeapSecondData;
    [FieldOffset(0x0474)] public readonly PEB_LeapSecond LeapSecondFlags;
    /// <summary>Compatibility: 1803 and higher</summary>
    ...
    [FieldOffset(0x0478)] public readonly uint NtGlobalFlag2;
